        ...
        <Card className="card-items">
          ...
          >
            ...
            <Button
              ...
              disabled={!auth.user.email_verified || !auth0.extended.getAccessToken()}
            >
              Add Item
            </Button>
          </Card.Header>
          ...
          {(itemsStatus === "loading" || itemsAreEmpty) && (
            <div className="py-5 px-3 align-self-center">
              ...
              {itemsStatus !== "loading" && itemsAreEmpty && auth0.extended.getAccessToken() && auth.user.email_verified && auth0.extended.getAccessToken() && (
                <>Nothing yet. Click the button to add your first item.</>
              )}
              { 
                (!auth.user.email_verified || !auth0.extended.getAccessToken()) && (
                  <>Please verify your account to add items</>
                )
              }
            </div>
          )}
